...
class GAN(object):
    ...
    def build_generator(self):
        ...
        sty = Dense(64, kernel_initializer='he_normal')(latent_input)
        sty = LeakyReLU(0.1)(sty)
        sty = Dense(64, kernel_initializer='he_normal')(sty)
        sty = LeakyReLU(0.1)(sty)
    ...
    def build_Dis_Model(self):
        ...
        interpolated_img = _merge_function([real_input, gout])
        dinterpolated = self.Discriminator(interpolated_img)

        dm = Model(inputs=[real_input, latent_input, noise_input, constant_input],
                   outputs=[dreal, dfake, dinterpolated])
